...
# learning2014 <- select(lrn14, keep_columns) #apparently a deprecated way of selecting columns.
learning2014 <- lrn14 %>% select(keep_columns)
...
colnames(learning2014)
colnames(learning2014)[c(2,7)] #not sure if I should print all column names or only the new/changed ones.
...
pairs(learning2014[-1], col = c("red", "blue")[factor(learning2014$gender)], oma = c(2, 2, 2, 10))
par(xpd = TRUE)
legend(0.95, 0.6, legend = unique(learning2014$gender), fill = c("red", "blue"))
